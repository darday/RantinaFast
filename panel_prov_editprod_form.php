...
$edit_id = $_GET['edit'];
$id_query = "Select * from producto  where id_producto='$edit_id'";
...
<header class="verdeoscuro">
	...
	<div class="container ">
			<section class="main row">
				...
				<h2 text-center>EDITAR PRODUCTO</h2>
					<form class="login100-form validate-form" method="post" action="panel_prov_editprod.php">
						...
						<div class="wrap-input100 validate-input m-b-26" data-validate="Campo Obligatorio">
							...
							<input class="input100" type="text" name="medida" value="<?php echo $row['medida']?>" placeholder="Libras,Litros,Unidades">
							<span class="focus-input100"></span>
						</div>
