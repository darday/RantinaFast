...
//echo $correo;
              try{
                  ...
                  $sql = "select * from producto where id_tipo = 1 && id_local = $id_user ";
              ...
              while($row = $result->fetch_array()) {
                if ($row != null) {
                  ...
                  ?>
                          ...
                          <td><a href='panel_prov_editprod_form.php?edit=<?php echo $id?>' title='Editar' ><i class='fas fa-edit'></i></a></td>
                          <td><a href='panel_prov_elimprod.php?del=<?php echo $id?>'><i class='fas fa-trash'></i></a></td>
                          <?php
                }
              }
              $result->close();
