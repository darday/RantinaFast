...
$(document).ready( function () {
  ...
  <div class="card-header">LISTAR PROVEEDOR</div>
              ...
              while($row = $run->fetch_array()) {
                if ($row != null) {
                  ...
                  ?>
                          ...
                          <td><a href='admin_editprov_form.php?edit=<?php echo $id?>' title='Editar' ><i class='fas fa-edit'></i></a></td>
