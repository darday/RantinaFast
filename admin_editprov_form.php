...
$id_prov=$_GET['edit'];
$id_query = "Select * from usuarios where idusuario='$id_prov'";
...
<header class="verdeoscuro">
	...
	<div class="container">
			<section class="main row">
				...
				<form class="login100-form validate-form" method="post" action="admin_editprov.php" enctype="multipart/form-data">
